...
# Source: BMW M Design Language (verbatim)

This is the canonical source spec as provided by the user. The DeadZone-mapped
version lives in `.lev/pm/designs/bmw-m-design-language.md`. Do not edit this
file — treat it as the immutable reference.
